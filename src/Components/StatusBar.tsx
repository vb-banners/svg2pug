...
export const StatusBar: React.FC = () => {
  ...
  const isFileProcessing = useAppStore((state) => state.isFileProcessing);
  const processingFileCount = useAppStore((state) => state.processingFileCount);
  ...
  return (
    ...
    >
      ...
      >
        ...
        {selectionInfo && (
          ...
          >
            ...
            <span>
              {selectionInfo.charCount} char{selectionInfo.charCount !== 1 ? 's' : ''},{' '}
              {selectionInfo.lineCount} line{selectionInfo.lineCount !== 1 ? 's' : ''}
            </span>
          </div>
        )}
      </div>
      ...
      {!isFileProcessing && statusMessage && (
        <div
          className="status-bar__message"
          style={{
            position: 'absolute',
      ...
      >
        ...
        {compressionStats &&
          ...
          compressionStats.pugGzipSize > 0 && (
            <div
              className="status-bar__item status-bar__compression"
