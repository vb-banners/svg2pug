...
export const FloatingControls: React.FC = () => {
  ...
  return (
    <div
      className="w-full border-b border-border flex items-center gap-4 px-6 py-3"
      style={{ backgroundColor: '#1E2431' }}
    >
      {/* Logo */}
      <div className="flex items-center gap-2">
        <h1 className="text-xl font-bold leading-none" style={{ color: '#C5C5C5' }}>
          SVG to PUG
        </h1>
        <span className="text-[10px] px-1.5 py-0.5 bg-[#FFD173]/20 text-[#FFD173] rounded-full font-medium uppercase">
          Beta
        </span>
      </div>
      ...
      <div className="flex items-center gap-4">
        ...
        >
          <div className="flex items-center space-x-2" title="Use spaces for indentation">
            ...
            <Label
              htmlFor="spaces"
              className="text-sm font-normal cursor-pointer leading-one mt-[7px]"
              style={{ color: '#C5C5C5' }}
            >
              Spaces
            </Label>
        ...
        <div className="flex items-center gap-4">
          <div
            ...
            title="Automatically copy converted Pug code to clipboard"
          >
            <Switch
              id="quickCopy"
          ...
          <div
            className="flex items-center space-x-2"
            title="Convert SVG id attributes to class attributes"
          >
            <Switch
              id="idToClass"
          ...
          <div
            className="flex items-center space-x-2"
            title="Extract common class prefixes (e.g., .popup.popup1 from .popup1)"
          >
            <Switch
              id="commonClasses"
