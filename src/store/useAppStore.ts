...
export const useAppStore = create<AppStore>()(
  persist(
    (set, get) => ({
      ...
      tabSize: 4,
      useSoftTabs: true,
      enableSvgIdToClass: migratedData.enableSvgIdToClass ?? true,
      enableCommonClasses: migratedData.enableCommonClasses ?? true,
      enablePugSizeVars: migratedData.enablePugSizeVars ?? true,
      enableQuickCopy: migratedData.enableQuickCopy ?? true,
      showPreview: migratedData.showPreview ?? true,
