...
export const SVGO_PLUGIN_OPTIONS: SvgoPluginOption[] = [
  ...
  // Styles & attributes
  { id: "cleanupAttrs", name: "Clean up attribute whitespace", enabledByDefault: true, category: "attributes", description: "Removes unnecessary whitespace in attribute values" },
  { id: "mergeStyles", name: "Merge styles", enabledByDefault: true, category: "attributes", description: "Merges multiple <style> elements into one" },
  { id: "inlineStyles", name: "Inline styles", enabledByDefault: true, category: "attributes", description: "Moves styles from <style> elements to inline style attributes" },
  { id: "minifyStyles", name: "Minify styles", enabledByDefault: true, category: "attributes", description: "Minifies CSS in <style> elements and style attributes" },
  { id: "convertStyleToAttrs", name: "Style to attributes", enabledByDefault: false, category: "attributes", description: "Converts style properties to SVG attributes (fill, stroke, etc.)" },
  { id: "removeUselessStrokeAndFill", name: "Remove useless stroke & fill", enabledByDefault: true, category: "attributes", description: "Removes stroke and fill attributes when they match defaults" },
  { id: "cleanupEnableBackground", name: "Remove/tidy enable-background", enabledByDefault: true, category: "attributes", description: "Removes or simplifies enable-background attribute" },
